...
<center>
    ...
    <table>
        ...
        <tr>
            <td>发布者姓名：</td>
            <td>
                <a href="/user/showUserInfo?id=${order_in_session.publishUser.id}">${order_in_session.publishUser.name}</a>
            </td>
        </tr>
        <tr>
            <td>发布者邮箱：</td>
        ...
        <tr>
            <td>承接者姓名：</td>
            <td><a href="/user/showUserInfo?id=${order_in_session.meetUser.id}">${order_in_session.meetUser.name}</a>
            </td>
        </tr>
        <tr>
            <td>承接者邮箱：</td>
        ...
        <tr>
            ...
            <td colspan="5">
                <textarea rows="8" cols="25" name="content" readonly
                          style="resize:none;">${order_in_session.demand.content}</textarea>
            </td>
